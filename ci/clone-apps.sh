...
git clone --depth 1 --branch version-14 https://github.com/intellimomentum/erpnext.git repos/erpnext
...
git clone --depth 1 --branch version-14 https://github.com/intellimomentum/erpnextfints.git repos/erpnextfints
git clone --depth 1 --branch main https://${username}:${PERSONAL_ACCESS_TOKEN}@github.com/intellimomentum/erpnext_customization.git repos/customization
